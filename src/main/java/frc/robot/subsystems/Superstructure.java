...
public class Superstructure {
   ...
   * This method sets up the necessary components and parameters for the path
   * planner.
   */
  public void configurePathPlanner() {
    AutoBuilder.configureHolonomic(
        swerve::getOdometryPose, swerve::resetPose, swerve::getChassisSpeeds,
        swerve::driveRobotCentric,
        new HolonomicPathFollowerConfig(
            new PIDConstants(5.0), new PIDConstants(5.0), MAX_LINEAR_SPEED_MPS,
            0.39878808909, new ReplanningConfig()),
        ()
            -> DriverStation.getAlliance().orElse(Alliance.Blue) ==
                   Alliance.Red,
        swerve);
    NamedCommands.registerCommand("Drive To Piece",
                                  driveToPiece().withTimeout(1.5));
  }
  ...
  /**
   * Drives the superstructure in angle-centric mode using the given Xbox
   * controller.
   *
   * @param xbox the Xbox controller used for driving
  ...
  /**
   * Aligns the superstructure to a game piece based on input from the Xbox
   * controller.
   *
   ...
   */
  public Command driveToPiece() { return swerve.driveToPiece(); }
   ...
   */
  public Command resetGyro() { return swerve.resetGyro(); }
  ...
  public Command offIntake() {
    return Commands
        ...
        .andThen(Commands.runOnce(() -> intake.setSpeed(-0.4)))
        .andThen(Commands.waitSeconds(1))
        .andThen(Commands.runOnce(() -> intake.setSpeed(0)));
  }

  public Command ejectIntake() {
    return Commands.startEnd(
        () -> intake.setSpeed(-0.4), () -> intake.setSpeed(0));
  }
  ...
  //  * This command is composed of two sequential commands: readyHandoff() and
  //  eject().
  //  *
  ...
  // /**
  //  * Returns a Command object that represents the action of moving the
  //  climber up.
  //  *
  ...
  // /**
  //  * Returns a Command object that represents the action of getting the
  //  shooter ready.
  //  *
  //  * @return a Command object representing the action of getting the shooter
  //  ready
  //  * @author sal and gre
  //  * @param sal
  //  */
  ...
  // /**
  //  * Returns a Command object that represents the action of getting ready for
  //  amplification.
  //  * This command is composed of two sub-commands: one for the arm to go to
  //  the amplification position,
  //  * and one for the shooter to get ready for amplification.
  //  *
  //  * @return The Command object representing the action of getting ready for
  //  amplification.
  //  */
